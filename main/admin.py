...
from .custom_actions import make_1cp, make_1cs, make_2cp, make_2cs
from .forms import (
    CustomAddAccessGroup,
    CustomAppForm,
    CustomChangeAccessGroup,
    CustomUserCreationForm,
    UsersFromCSVForm,
)
from .models import AccessGroup, App, DefaultUser, Pod, UsersFromCSV
...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ("username", "email", "is_staff", "role", "group", "apps_available")
    ...
    def get_urls(self):
        ...
        new_urls = [
            path(
                "add_from_csv/",
                UsersFromCSVAdmin(UsersFromCSV, admin_site=admin.site).add_view,
                name="add_from_csv",
            )
        ]
